...
- Hyperlink to MOSIP content wherever it can be done
- Scope topic - Some steps Rachik may have written may be inconsistent, identify if these are sufficient or may need more of steps. (Kind of templatize it)
  - Can we also not bring the API documentation together with scope topic?
- Integration Limitation - is there, can be better worded
